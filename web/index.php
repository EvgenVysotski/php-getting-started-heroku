...
<!-- кнопки для слайдера-->
          ...
          <!--Страница истории Alpine A110-->
           <div class="page_history">
            ...
            <div class="contact container-fluid">
                <h1><a name ="contact">контакты</a></h1>
    ...
    <div class="menu visible-md-inline-block visible-xs-inline-block visible-sm-inline-block hidden-l">
